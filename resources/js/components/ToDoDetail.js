...
import useUpdateToDoDetailMutateTask from "../hooks/ToDoDetail/useUpdateToDoDetailMutateTask";
import useDeleteToDoDetailMutateTask from "../hooks/ToDoDetail/useDeleteToDoDetailMutateTask";
...
function ToDoDetail(props) {
    ...
    return (
        <ListItem
            key={props.detail.id}
            secondaryAction={
                <IconButton edge="end" aria-label="delete" onClick={eventDeleteToDoDetail}>
                    <Delete />
                </IconButton>
            }
            disablePadding
